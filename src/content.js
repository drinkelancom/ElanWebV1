  ...
  nl: {
    ...
    legal: {
      ...
      cookiebeleid: {
        ...
        button: 'Cookievoorkeur wijzigen',
        mock: true,
        intro: 'Dit is een voorlopige versie. De definitieve juridische tekst volgt.',
        sections: [
          ['Wat zijn cookies', 'Cookies zijn kleine bestanden die op je apparaat worden opgeslagen om de website goed te laten werken.'],
          ['Functionele cookies', 'Deze zijn nodig om de site te laten werken en staan er altijd. Het gaat om je taalkeuze (nl of en) en om je antwoord op de cookievraag zelf. Ze worden in je browser opgeslagen, gaan niet naar ons toe en worden niet met anderen gedeeld.'],
          ['Analytische cookies', 'We gebruiken Google Analytics 4 om te zien welke pagina’s bezocht worden en waar bezoekers vandaan komen. Dat gebeurt alleen als je op Accepteren klikt. Google plaatst dan de cookies _ga en _ga_8Q2Y5RGQ9Q, die tot twee jaar op je apparaat blijven staan.'],
          ['Zonder toestemming', 'Klik je op Weigeren of sluit je de melding, dan worden er geen analytische cookies geplaatst en herkennen we je niet bij een volgend bezoek. Google Analytics ontvangt dan alleen een geanonimiseerd signaal dat een pagina bekeken is, zonder gegevens die naar jou te herleiden zijn.'],
          ['Je keuze wijzigen', 'Je kunt je toestemming op elk moment intrekken of alsnog geven met de knop hieronder. Daarnaast kun je cookies altijd verwijderen via de instellingen van je browser.'],
        ],
      },
    },
  },
  ...
  en: {
    ...
    legal: {
      ...
      cookiebeleid: {
        ...
        button: 'Change cookie preference',
        mock: true,
        intro: 'This is a preliminary version. The final legal text will follow.',
        sections: [
          ['What are cookies', 'Cookies are small files stored on your device to make the website work properly.'],
          ['Functional cookies', 'These are needed for the site to work and are always on. They cover your language choice (nl or en) and your answer to the cookie question itself. They stay in your browser, are not sent to us and are not shared with anyone.'],
          ['Analytics cookies', 'We use Google Analytics 4 to see which pages get visited and where visitors come from. This only happens if you click Accept. Google then sets the cookies _ga and _ga_8Q2Y5RGQ9Q, which stay on your device for up to two years.'],
          ['Without consent', 'If you click Decline or dismiss the notice, no analytics cookies are set and we will not recognise you on a return visit. Google Analytics then receives only an anonymous signal that a page was viewed, with no data that can be traced back to you.'],
          ['Changing your choice', 'You can withdraw or give your consent at any time using the button below. You can also delete cookies at any time through your browser settings.'],
        ],
      },
    },
  },
